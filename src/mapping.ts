import { TransferCall, TransferFromCall } from './types/SimianToken/SimianToken'
...
// Handles a Transfer call to the token contract
...
// Handles a TransferFrom call to the token contract
export function handleTransferFrom(call: TransferFromCall): void {
  ...
  transfer.from = call.inputs.sender
  transfer.to = call.inputs.recipient
